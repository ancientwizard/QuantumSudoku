...
describe('strategy/base', () => {
    ...
    test('is-plain', () => {
     ...
     // console.log(unit.toString());
        ...
        expect(TF(unit).toStringValues()).toBe('5 6 2 8 7 9 4 3 1')
