...
describe('strategy/pair', () => {
    ...
    test('naked-pair', () => {
        ...
        expect(unit.as_cell_array[CellIndex.FOUR.index].toString()).toBe('# A4: ? [ 7,8 ]')
        expect(unit.as_cell_array[CellIndex.FIVE.index].toString()).toBe('# A5: ? [ 7,8 ]')

        expect(strategy.apply( unit )).toBe(true)
        expect(unit.as_cell_array[CellIndex.ONE.index].toString()).toBe('# A1: ? [ 1,2,3,4,5,6 ]')
        expect(unit.as_cell_array[CellIndex.TWO.index].toString()).toBe('# A2: ? [ 1,2,3,4,5,6 ]')
        expect(unit.as_cell_array[CellIndex.SIX.index].toString()).toBe('# A6: ? [ 1,2,3,4,5,6 ]')
        ...
        expect(unit.as_cell_array[CellIndex.SEVEN.index].toString()).toBe('# A7: ? [ 3,6 ]')
        expect(unit.as_cell_array[CellIndex.EIGHT.index].toString()).toBe('# A8: ? [ 3,6 ]')

        expect(strategy.apply( unit )).toBe(true)
        expect(unit.as_cell_array[CellIndex.TWO.index].toString()).toBe('# A2: ? [ 1,2,4,5 ]')
        expect(unit.as_cell_array[CellIndex.SIX.index].toString()).toBe('# A6: ? [ 1,2,4,5 ]')
    ...
    test('hidden-pair(A)', () => {
        ...
        expect(unit.as_cell_array[CellIndex.TWO.index].toString()).toBe('# A2: ? [ 1,3,4,5,6,9 ]')
        expect(unit.as_cell_array[CellIndex.FIVE.index].toString()).toBe('# A5: ? [ 1,3,4,5,6,9 ]')
        expect(strategy.apply( unit )).toBe(true)
        expect(unit.as_cell_array[CellIndex.TWO.index ].toString()).toBe('# A2: ? [ 3,4 ]')
        expect(unit.as_cell_array[CellIndex.FIVE.index].toString()).toBe('# A5: ? [ 3,4 ]')
        ...
        expect(unit.as_cell_array[CellIndex.THREE.index].toString()).toBe('# A3: ? [ 1,5,6,9 ]')
        expect(unit.as_cell_array[CellIndex.EIGHT.index].toString()).toBe('# A8: ? [ 1,5,6,9 ]')
        expect(strategy.apply( unit )).toBe(true)
        expect(unit.as_cell_array[CellIndex.THREE.index].toString()).toBe('# A3: ? [ 6,9 ]')
        expect(unit.as_cell_array[CellIndex.EIGHT.index].toString()).toBe('# A8: ? [ 6,9 ]')
    ...
    test('hidden-pair(B)', () => {
        ...
        expect(unit.as_cell_array[CellIndex.EIGHT.index].toString()).toBe('# A8: ? [ 1,2,3,4,5,6,9 ]')
        expect(unit.as_cell_array[CellIndex.NINE.index ].toString()).toBe('# A9: ? [ 1,2,3,4,5,6,9 ]')
        expect(strategy.apply( unit )).toBe(true)
        expect(unit.as_cell_array[CellIndex.EIGHT.index].toString()).toBe('# A8: ? [ 3,4 ]')
        expect(unit.as_cell_array[CellIndex.NINE.index ].toString()).toBe('# A9: ? [ 3,4 ]')
        ...
        expect(unit.as_cell_array[CellIndex.FIVE.index].toString()).toBe('# A5: ? [ 1,2,5,6,9 ]')
        expect(unit.as_cell_array[CellIndex.SIX.index ].toString()).toBe('# A6: ? [ 1,2,5,6,9 ]')
        expect(strategy.apply( unit )).toBe(true)
        expect(unit.as_cell_array[CellIndex.FIVE.index ].toString()).toBe('# A5: ? [ 1,9 ]')
        expect(unit.as_cell_array[CellIndex.SIX.index  ].toString()).toBe('# A6: ? [ 1,9 ]')
        expect(unit.as_cell_array[CellIndex.TWO.index  ].toString()).toBe('# A2: ? [ 2,5,6 ]')
        expect(unit.as_cell_array[CellIndex.THREE.index].toString()).toBe('# A3: ? [ 2,5,6 ]')
        expect(unit.as_cell_array[CellIndex.SEVEN.index].toString()).toBe('# A7: ? [ 2,5,6 ]')
