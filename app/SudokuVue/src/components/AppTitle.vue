...
// Set one true to suw that title styling
const showOne      = false
const showTwo      = false
const showTwoAlt   = true   // FAVE
const showThree    = false
const showFour     = false
const showFive     = false
const showSix      = false  // FAVE
const showSeven    = false
...
<span class="cowboy">
  ...
  <div v-if="showTwoAlt" class="two alt-two">
    <h1>{{ title }}
      <span>{{ tagline }}</span>
    </h1>
  </div>

  <div v-if="showThree" class="three">
    <h1>{{ title }}</h1>
  </div>

  <div v-if="showFour" class="four">
    <h1><span>{{ tagline }}</span>{{ title }}</h1>
  </div>

  <div v-if="showFive" class="five">
    <h1>{{ title }}
      <span>{{ tagline }}</span>
    </h1>
  </div>

  <div v-if="showSix" class="six">
    <h1>{{ title }}
      <span>{{ tagline }}</span>
    </h1>
  </div>

  <div v-if="showSeven" class="seven">
    <h1>{{ title }}</h1>
  </div>

  <div v-if="showEight" class="eight">
    <h1>{{ title }}</h1>
  </div>

  <div v-if="showNine" class="nine">
    <h1>{{ title }}<span>{{ tagline }}</span></h1>
  </div>

  <div v-if="showTen" class="ten">
    <h1>{{ title }}</h1>
  </div>
  ...
  <div v-if="showThirteen" class="thirteen">
    <h1>{{ title }}</h1>
  </div>
